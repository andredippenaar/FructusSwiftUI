...
//  SettingsView
//
//  Created by Andre Dippenaar on 2021/08/03.
//
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                       ...
                       SettingsRowView(name: "Developer", content: "Andre Dippenaar")
                        SettingsRowView(name: "Designer", content: "Robert Patras")
                        SettingsRowView(name: "Compatibility", content: "iOS 14")
                        SettingsRowView(name: "Website", linkLabel: "SwiftUI Masterclass", linkDestination: "swiftuimasterclass.com")
                        SettingsRowView(name: "Twitter", linkLabel: "@Andre_Dippenaar", linkDestination: "twitter.com/andre_dippenaar")
